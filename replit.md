...
- **Team Training Management:** Features for requesting team training quotes, generating monthly Stripe invoices for team contracts, and automating team user creation upon payment. This includes contract-linked session scheduling and coach payout calculations based on contract value.
