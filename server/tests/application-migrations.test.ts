...
test("migration readiness exposes only expected/applied identifiers and state", async () => {
  ...
  assert.equal(state.latestExpected, "0021_connector_tokens_org_connector_unique.sql");
  assert.equal(state.latestApplied, "0021_connector_tokens_org_connector_unique.sql");
