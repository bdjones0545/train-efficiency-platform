...
const NAV_REGISTRY: NavEntry[] = [
  ...
  },
  {
    ...
    route: "/admin/billing-intelligence",
    requiredRoles: ["ADMIN"],
  ...
  {
    intent: "view_lead_pipeline",
    route: "/admin/lead-pipeline",
    requiredRoles: ["ADMIN", "COACH"],
    label: "Open Lead Pipeline",
    description: "Review lead intelligence, drafts, and pipeline stages",
  },
  {
    intent: "review_ai_approvals",
    route: "/admin/ai-approvals",
    requiredRoles: ["ADMIN", "COACH"],
    label: "Open AI Approvals",
    description: "Review and approve pending AI-drafted communications",
  },
  {
