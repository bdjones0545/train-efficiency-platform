...
export async function registerSchedulingIntelligenceRoutes(
  ...
  await validateSchedulingSchema().catch((error) => {
    ...
    console.error("[scheduling] formal schema unavailable; intelligence routes remain degraded:", error);
  });
  if (schemaUnavailable) {
    app.use("/api/scheduling-intelligence", isAuthenticated, (_req, res) =>
