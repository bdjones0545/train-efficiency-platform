...
The scan found runtime DDL in 45 production modules besides the new bootstrap module. The main
...
AgentMail, payments/Stripe, autonomy authorization, email-audit authorization, privilege
escalation, and webhook exploit work were excluded from investigation and changes as required.
