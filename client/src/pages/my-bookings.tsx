...
export default function MyBookingsPage() {
  ...
  const renderUpcomingBooking = (booking: BookingWithDetails) => (
    <UpcomingSessionCard key={booking.id}>
      <Card
          ...
          {booking.status === "CONFIRMED" && (
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel
                    data-testid={`button-keep-booking-${booking.id}`}
                  >
                    Keep Booking
                  </AlertDialogCancel>
                  <AlertDialogAction
  ...
  const renderPastBooking = (booking: BookingWithDetails) => (
    <Card
      key={booking.id}
      className="p-4"
      data-testid={`card-booking-${booking.id}`}
        ...
        <Tabs defaultValue="upcoming">
          ...
          <TabsContent value="upcoming" className="space-y-3 mt-4">
            {upcoming.length === 0 ? (
              ...
              upcoming.map((b) => renderUpcomingBooking(b))
            )}
          </TabsContent>
          ...
          <TabsContent value="past" className="space-y-3 mt-4">
            {past.length === 0 ? (
              ...
              past.map((b) => renderPastBooking(b))
            )}
          </TabsContent>
        </Tabs>
      </PortalSectionReveal>
