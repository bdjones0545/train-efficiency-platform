...
import AdminMarketIntelligencePage from "@/pages/admin-market-intelligence";
...
import AdminFillRevenueOpsPage from "@/pages/admin-fill-revenue-ops";
            ...
            <div className={isFullscreenPage ? "h-full" : "max-w-5xl mx-auto"}>
              <SubscriptionGate>
                ...
                <Switch>
                  ...
                  <Route path="/admin/market-intelligence" component={AdminMarketIntelligencePage} />
                  ...
                  <Route path="/admin/agentmail-analytics" component={AdminAgentmailAnalyticsPage} />
                  ...
                  <Route path="/admin/fill-revenue-ops" component={AdminFillRevenueOpsPage} />
